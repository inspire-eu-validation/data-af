...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/af/4.0/AgriculturalAndAquacultureFacilities.xsd, using strict XML schema validation.
